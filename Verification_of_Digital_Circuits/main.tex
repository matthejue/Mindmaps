              ...
              \begin{minipage}[t]{12cm}
                \begin{itemize}
                  ...
                  \begin{itemize}
                    ...
                    \end{itemize}
                    \item \script{193}{Variable Elimination}: The DP-algorithm applies resolution to eliminate a variable $x_i$ completely from the formula, i. e., all occurrences of $x_i$ and $\neg x_i$. The goal is to reduce the number of variables.
                      \begin{itemize}
                        ...
                        \item \script{201}{Example}
                      \end{itemize}                             
                    \item \script{202}{Davis-Putnam Algorithm}
                  \end{itemize}
