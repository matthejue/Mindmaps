...
\begin{minipage}[t]{0.2\linewidth}
	...
	\begin{betterlist}
		\item A \script{279}{\alert{control-flow graph}} is a tuple $G = (Loc, \Delta , \ell init, \ell ex)$ where
		\begin{betterlist}
...
\begin{minipage}[t]{0.2\linewidth}
	...
	\begin{betterlist}
		...
		\begin{betterlist}
			...
			\end{betterlist}
			\item there exist $a\ell 1,\ldots , a\ell n, b\ell 1,\ldots , b\ell n$ such that
			\begin{betterlist}
