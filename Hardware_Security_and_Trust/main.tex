				...
				node {Hardware Security Attacks and Countermeasures
						\resizebox{\textwidth}{!}{
							\begin{minipage}[t]{12cm}
								\begin{itemize}
									\item \script{255}{Side-channel and fault injection}
								\end{itemize}
							\end{minipage}
						}
					}
				...
				child {
						node {Fault Injection
								\resizebox{\textwidth}{!}{
									\begin{minipage}[t]{12cm}
										\begin{itemize}
											\item \script{255}{Definition}, using side-channel inputs
											\item \script{256}{Side channel inputs for fault injection}
										\end{itemize}
									\end{minipage}
								}
							}
						...
						child {
								node {Meltdown and Spectre
										\resizebox{\textwidth}{!}{
											\begin{minipage}[t]{12cm}
												\begin{itemize}
													\item \script{202}{Main idea}, exploited vulnerabilties
													...
													\begin{minipage}[t]{12cm}
														\begin{itemize}
															...
															\begin{itemize}
																...
																\begin{itemize}
																	\item \script{230}{Precondition and Code}
																\end{itemize}
																\item \script{233}{Step 2: Flushing the cache lines, Measure access times}
																\item \script{235}{Exception handling (pr.)}
																\item \script{236}{Race condition}
																\begin{itemize}
																	\item \script{237}{Steps in the race}
																\end{itemize}
															\end{itemize}
															\item \script{238}{Leak whole memory}
															\item \script{239}{Summary and Visualization}
										...
										child {
												node {Reservation stations (RSs) and Functional Units (FUs)
														\resizebox{\textwidth}{!}{
															\begin{minipage}[t]{12cm}
																\begin{itemize}
																	\item \script{206}{Definition}, Retiring phase
																	\begin{itemize}
										...
										child {
												node {Virtual memory management with paging
														\resizebox{\textwidth}{!}{
															\begin{minipage}[t]{12cm}
																\begin{itemize}
																	\item \script{224}{Definition}
																	\item \script{225}{Adress Translation Illustration}
												...
												\resizebox{\textwidth}{!}{
													\begin{minipage}[t]{12cm}
														\begin{itemize}
															...
															\item \script{242}{Overview} and \script{244}{More}
															\item \script{245}{Code (ff.)}
															\item \script{250}{Other Application Scenarios}
															\item \script{251}{Countermeasures}
														\end{itemize}
													\end{minipage}
												}
											}
