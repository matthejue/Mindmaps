	...
	\begin{betterlist}
		...
		\begin{betterlist}
			...
			\begin{betterlist}
              ...
              \item tried out all possibilities, proof by case distinction over all reachable configurations
							% \item yes, if the ARG has no error configurations, then it is a safety proof
			...
			\begin{betterlist}
				...
				\framebox[0.95\textwidth][l]{\parbox{0.90\textwidth}{
						\begin{betterlist}
							\item no, because $sp(\{\varphi\}, st) \subseteq \{\varphi'\}$ might overapproximate
						\end{betterlist}
					}}
			\end{betterlist}
			\item Which assumptions (on the program, or the specification, or the program’s environment) are needed for soundness?
		...
		\begin{betterlist}
			...
			\begin{betterlist}
				...
				\framebox[0.95\textwidth][l]{\parbox{0.90\textwidth}{
						\begin{betterlist}
							\item no, may not terminate, may iterate over infinitely many initial configurations and may add infinitely many configurations while processing the worklist
						\end{betterlist}
					}}
				\item Does the technique always terminate for incorrect programs? If not, what might the technique do for an infinite amount of time (which step of the algorithm)? In which cases can this occur?
	...
	\begin{betterlist}
		...
		\begin{betterlist}
			...
			\begin{betterlist}
				...
				\framebox[0.95\textwidth][l]{\parbox{0.90\textwidth}{
						\begin{betterlist}
							\item yes, if algorithm terminates and no error location has been found, then none is reachable
						\end{betterlist}
					}}
			\end{betterlist}
			\item \underline{For incorrect programs}
			\begin{betterlist}
				...
				\framebox[0.95\textwidth][l]{\parbox{0.90\textwidth}{
						\begin{betterlist}
							\item yes, because $sp(\{\varphi\}, st) = \{\varphi'\}$
						\end{betterlist}
					}}
			\end{betterlist}
			\item Which assumptions (on the program, or the specification, or the program’s environment) are needed for soundness?
		...
		\begin{betterlist}
			...
			\begin{betterlist}
				...
				\framebox[0.95\textwidth][l]{\parbox{0.90\textwidth}{
						\begin{betterlist}
							\item no, only if there's a timeout in case that it's going to run infintely or just a too long running example
						\end{betterlist}
					}}
				\item Given an incorrect program, is it possible that the technique terminates with an UNKNOWN verdict? If so, in which cases can this happen?
