										...
										\resizebox{\textwidth}{!}{
											\begin{minipage}[t]{12cm}
												\begin{itemize}
													...
													\item \script{937}{Examples}
													\item \script{965}{Decomposition theorem (ff.)}
													\begin{itemize}
														...
														\item \script{974}{Proof (ff.)}
													\end{itemize}
													\begin{itemize}
														\item \script{956}{Only property both Safe and Live}
													\end{itemize}
												\end{itemize}
											\end{minipage}
										}
													...
													\begin{minipage}[t]{18cm}
														\begin{itemize}
															...
															\begin{itemize}
																...
																\item \script{960}{Definition with closure (pr.)}
															\end{itemize}
														...
														\resizebox{\textwidth}{!}{
															\begin{minipage}[t]{12cm}
																\begin{itemize}
																	...
																	\begin{itemize}
																		\item \script{902}{Proof (ff.)}
																	\end{itemize}
																	\item \script{898}{Examples}
																\end{itemize}
															\end{minipage}
														}
													}
								...
								child {
										node {Liveness properties
												\resizebox{\textwidth}{!}{
													\begin{minipage}[t]{16cm}
														\begin{itemize}
															\item \script{941}{Definition}
															\begin{itemize}
																\item \script{945}{Examples (ff.)}
															\end{itemize}
															\item \script{926}{Categories with examples}
															\begin{itemize}
																\item \alert{liveness:} \enquote{something good will happen}
															\end{itemize}
														\end{itemize}
													\end{minipage}
												}
