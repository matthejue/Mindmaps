...
\fontsize{1.3pt}{1.3pt}\selectfont
...
\begin{minipage}[t]{0.16\linewidth}
	...
	\begin{betterlist}
		...
		\framebox[0.90\textwidth][l]{\parbox{0.85\textwidth}{
				\begin{betterlist}
					\allpre
					\item have no inference rule for assert, but can replace by if as above
				\end{betterlist}
			}}
		\item \alert{Soundness}
		\begin{betterlist}
