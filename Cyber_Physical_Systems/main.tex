												...
												\resizebox{\textwidth}{!}{
													\begin{minipage}[t]{12cm}
														\begin{itemize}
															...
															% \begin{itemize}
															% 	\item \script{779}{Alternative depiction and examples}
															% \end{itemize}
															\begin{itemize}
														...
														\resizebox{\textwidth}{!}{
															\begin{minipage}[t]{12cm}
																\begin{itemize}
																	...
																	\item \script{727}{Definition}, invariantly the not bad thing holds true
																	\begin{itemize}
												...
												child {
														node {DFS-based invariant checking
																\resizebox{\textwidth}{!}{
																	\begin{minipage}[t]{12cm}
																		\begin{itemize}
																			\item \script{756}{Algorithm}
																			\begin{itemize}
																				\item \script{752}{Input and Output}
																				\item \script{766}{Resursive DFS}
																			\end{itemize}
