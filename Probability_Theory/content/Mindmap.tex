                  ...
                  \begin{minipage}[t]{12cm}
                    \begin{itemize}
                      ...
                      \item $\begin{aligned}[t]\displaystyle 1 &= \sum_{x\in dom(f_X)} \sum_{y\in dom(f_Y)} f_{XY}(x, y) = \sum_{x\in dom(f_X)} \sum_{y\in dom(f_Y)} c\cdot(2f_X(x) + 3f_Y(y))\\
                          &= \sum_{x\in dom(f_X)} \sum_{y\in dom(f_Y)} c\cdot(2f_X(x) + 3f_Y(y)) = \sum_{x\in dom(f_X)} 2\cdot c\cdot(2f_X(x) + 3(\frac{1}{4})) + c\cdot(2f_X(x) + 6(\frac{1}{4}))\\ 
                          &= \sum_{x\in dom(f_X)} 2\cdot c\cdot(4f_X(x) + 12(\frac{1}{8})) = 2\cdot c \cdot(4(\frac{1}{8}) + 12(\frac{1}{8})) + 2\cdot c \cdot(8(\frac{1}{8}) + 12(\frac{1}{8})) + 2\cdot c \cdot(4(\frac{1}{8}) + 12(\frac{1}{8}))\\ 
                          &= 2\cdot c\cdot (2\cdot (4(\frac{1}{4}) + 12(\frac{1}{8})) + 8(\frac{1}{4}) + 12(\frac{1}{8})) = 2\cdot c\cdot (2 + \frac{6}{2} + 2 + \frac{3}{2} ))) = (2\cdot 8.5) \cdot c \Leftrightarrow c = \frac{1}{17} 
                        \end{aligned}$
                      \end{itemize}               
                        \begin{table}
                          \centering
                      ...
                      \item \alert{Beispiel für Unabhängigkeit in Kontingenztafeln:}
                        \begin{itemize}
                          ...
                          \item $f_{X, Y} = \begin{cases}
                              c\cdot(2f_X(x) + 3f_Y(y)) & 0 \le x\le 2, 0\le y\le 3 \\
                              0 &
                            \end{cases}$
                          \item $\begin{aligned}[t]\displaystyle 1 &= \sum_{x\in dom(f_X)} \sum_{y\in dom(f_Y)} f_{XY}(x, y) = \sum_{x\in dom(f_X)} \sum_{y\in dom(f_Y)} c\cdot(2f_X(x) + 3f_Y(y))\\
                          &= \sum_{x\in dom(f_X)} \sum_{y\in dom(f_Y)} c\cdot(2f_X(x) + 3f_Y(y)) = \sum_{x\in dom(f_X)} 2\cdot c\cdot(2f_X(x) + 3(\frac{1}{8})) + 2\cdot c\cdot(2f_X(x) + 9(\frac{1}{8}))\\ 
                          &= \sum_{x\in dom(f_X)} 2\cdot c\cdot(4f_X(x) + 12(\frac{1}{8})) = 2\cdot c \cdot(4(\frac{1}{8}) + 12(\frac{1}{8})) + 2\cdot c \cdot(8(\frac{1}{8}) + 12(\frac{1}{8})) + 2\cdot c \cdot(4(\frac{1}{8}) + 12(\frac{1}{8}))\\ 
                          &= 2\cdot c\cdot (2\cdot (4(\frac{1}{4}) + 12(\frac{1}{8})) + (8(\frac{1}{4}) + 12(\frac{1}{8})))) = 17 \Leftrightarrow c = \frac{1}{17} 
                            \end{aligned}$
                          \end{itemize}               
                        \begin{table}
                          \centering
