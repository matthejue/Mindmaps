...
\begin{minipage}[t]{0.31\textwidth}
	...
	\textcolor{PrimaryColor}{
		...
		\begin{center}
			\large
			\textsc{\iftoggle{isEnglish}{Hike Through the Ravenna Gorge in Hell’s Valley}{}}
		\end{center}
		\rule{\linewidth}{0.5mm}
	}
	...
	\iftoggle{isEnglish}{
		...
		The origin of the name \alert{\enquote{Höllental} (Hell's Valley)} comes from historical references to the valley's narrow and rugged geography, particularly the Hirschsprung gorge area. As early as 1691, Emperor Leopold I described the present-day Hirschsprung as "die Höll", which in German could mean "hell" or "hollow". Later, during the French retreat in 1796, the valley was referred to as "Val d'enfer", which translates directly to "Hell Valley" in French. These descriptions of the valley's treacherous terrain and dramatic landscape contributed to the adoption of the name Höllental.
	}{
	}
...
\begin{minipage}[t]{0.31\textwidth}
	...
	\iftoggle{isEnglish}{
		...
		The \alert{\enquote{Ravennaschlucht} (Ravenna Gorge)}, a side valley branching off from the Höllental near Hinterzarten, is one of the region’s most striking landmarks. Its name likely stems from French or other Romance-language roots. It is derived from the word \enquote{la ravine}, meaning ravine or gorge. This name reflects the dramatic, narrow landscape of the area and was already in use by 1560.
...
\begin{minipage}[t]{0.31\textwidth}
	...
	\includegraphics[width=\linewidth]{./figures/marie_antionette2_resized.png}
	\captionof{figure}{\iftoggle{isEnglish}{Marie Antoinette with her two eldest children, Marie-Thérèse-Charlotte and dauphin Louis-Joseph}{}}
	\setlength{\parskip}{0.25cm}
...
\begin{minipage}[t]{0.31\textwidth}
	...
	\iftoggle{isEnglish}{
		...
		% \alert{Marie Antoinette}, the last queen of France before the Revolution, was born in 1755 as an Austrian archduchess and married Louis XVI at 14. As the revolution gathered force, her life turned from a world of opulent privilege into a slow and public descent into tragedy.
		\alert{Marie Antoinette}, France’s last queen before the Revolution, was born an Austrian archduchess in 1755 and married Louis XVI at 14. As the Revolution rose, her life fell from opulence to public tragedy.
...
\begin{minipage}[t]{0.31\textwidth}
	...
	\iftoggle{isEnglish}{
		...
		\alert{\enquote{Bubenstein Castle}}, sometimes also referred to as \enquote{Neufalkenstein}, was built later as a successor to Falkenstein Castle. It was constructed by the Lords of Falkenstein in the late 13th century, likely between 1270 and 1300, when Falkenstein Castle became less practical or defensible.
...
\begin{minipage}[t]{0.31\textwidth}
	...
	\iftoggle{isEnglish}{
		The name \alert{\enquote{Bubenstein}} is believed to originate from \enquote{Bube}, meaning a young noble or squire, possibly in reference to a younger branch of the Falkenstein family or a secondary seat. Like its predecessor, Bubenstein Castle was used to monitor and control traffic along the valley road, but it was larger and better suited for residence. It was eventually abandoned in the 16th century. In 1880, parts of the castle were demolished to make way for the Höllentalbahn railway line, which passes directly below the former castle site.%Today, remnants of the walls and foundation can still be visited along a forest path near the Himmelreich train station.
		The alternative name \enquote{Neufalkenstein} underlines its direct connection to the older Falkenstein Castle.

		\alert{Kuno von Falkenstein}, known as the \enquote{crusader knight} of Höllental, died on 12 May 1343. Legend surrounds Kuno’s extraordinary return from the Crusades.
	}{
	}
