										...
										child {
												...
												child {
														...
														child {
																...
																child {
																		node {Modern Sat: Constraint Propagation (BCP) or Unit Propagation}
																		child {
																				node {Assignments}
																			}
																	}
																child {
																		node {DLL: Repeated application of the unit clause rule on recursion level until nothing changes}
																	}
															}
														child {
																node {Different meaning for Contradiction / Conflict}
																child {
																		node {Modern SAT: Learning of a conflict clause}
																	}
																child {
																		node {DLL: Combination of the previously done decisions will always be considered}
																		child {
