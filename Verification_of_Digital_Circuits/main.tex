						...
						child {
								node {Deterministic Finite Automata (DFA)
										\resizebox{\textwidth}{!}{
											\begin{minipage}[t]{12cm}
												\begin{itemize}
													\item \script{459}{Definition}, also called \alert{transducer}, \script{528}{Compact}
													\begin{itemize}
												...
												child {
														node {Characteristic functions
																\resizebox{\textwidth}{!}{
																	\begin{minipage}[t]{12cm}
																		\begin{itemize}
																			\item \script{501}{Definition and characteristic boolean functions}, can be represented by BDDs or AIGs
										...
										child {
												node {Special form
														\resizebox{\textwidth}{!}{
															\begin{minipage}[t]{12cm}
																\begin{itemize}
																	\item \script{529}{Definition}
																	\item \script{531}{Equivalence check (pr.)}
																	\item \script{536}{Method}
																	\begin{itemize}
																		\item \script{537}{Illustration}
																		\item \script{539}{Symbolic Traversal of Automata} and \script{546}{Computation of all reachable states}
																	\end{itemize}
																\end{itemize}
															\end{minipage}
														}
												...
												child {
														node {Partial Orders
																\resizebox{\textwidth}{!}{
																	\begin{minipage}[t]{12cm}
																		\begin{itemize}
																			\item \script{548}{Definition and \alert{Supremum}}
																			\item \script{550}{Infimum}
																		\end{itemize}
																	\end{minipage}
																}
															}
												...
												child {
														node {Lattice
																\resizebox{\textwidth}{!}{
																	\begin{minipage}[t]{12cm}
																		\begin{itemize}
																			\item \script{553}{Definition, \alert{Complete Lattice} (prr.)}
																			\item \script{554}{Example}
																		\end{itemize}
																	\end{minipage}
																}
															}
												...
												child {
														node {Monotonicity and Continuity
																\resizebox{\textwidth}{!}{
																	\begin{minipage}[t]{12cm}
																		\begin{itemize}
																			\item \script{558}{Monotone Increasing / Decreasing, Upward / downward continuous}
																			\begin{itemize}
