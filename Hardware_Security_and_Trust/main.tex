                    ...
                    \resizebox{\textwidth}{!}{
                      \begin{minipage}[t]{12cm}
                        \begin{itemize}
                          ...
                          \begin{itemize}
                            \item \script{164}{Proof and \enquote{Extended} Euklid‘s algorithm (ff.)}
                          \end{itemize}
                        \end{itemize}
                      \end{minipage}
                    }
                    ...
                    \resizebox{\textwidth}{!}{
                      \begin{minipage}[t]{12cm}
                        \begin{itemize}
                          ...
                          \begin{itemize}
                            \item Theorem (MA') implies Theorem(MA), \script{157}{Proof}, \script{162}{Proof 2}
                          \end{itemize}
                        ...
                        \begin{itemize}
                          \item \script{159}{Proof with Euklid's algorithm (f.)}
                          \begin{itemize}
                            \item \script{161}{\enquote{Extended} Euklid's algorithm}
                          \end{itemize}
                        \end{itemize}
                        \end{itemize}
                      \end{minipage}
