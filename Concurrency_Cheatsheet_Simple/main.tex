...
func signal(qsem *QSem) {
  ...
  if qsem.curr < qsem.q {
	...
	\begin{betterlist}
		...
		\end{betterlist}
	\end{betterlist}
	\inlinebox{Lamport's \cul{happens-before (HB, incomplete and unsound) relation}}
	\begin{betterlist}
...
\begin{minipage}[t]{0.195\linewidth}
	\raggedright
	\inlinebox{Lamport's \cul{happens-before relation cont.}}
	\begin{betterlist}
...
\begin{minipage}[t]{0.195\linewidth}
	...
	\adjustbox{scale=0.48}{
        ...
        func (p1 *Promise[T]) tryCompleteWith(
         p2 *Promise[T]) {
