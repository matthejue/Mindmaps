                          ...
                          \resizebox{\textwidth}{!}{
                            \begin{minipage}[t]{12cm}
                              ...
                              \begin{itemize}
                                ...
                                \end{itemize}
                                \item this procedure just looks at the preceding stages of the \alert{single cycle diagram} as \alert{forwarding} can only happen within the single cycle diagramm
                              \end{itemize}
                            \end{minipage}
                          }
                        }
