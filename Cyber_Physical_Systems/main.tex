      ...
      child {
        node {Predicate Logic
          \resizebox{\textwidth}{!}{
            \begin{minipage}[t]{16cm}
              \begin{itemize}
                \item $\overset{\infty}{\exists}i \in \mathbb{N}_0: \text{cond} = \forall j\in \mathbb{N}_0:\exists i\in\mathbb{N}_0: j < i \;\operatorname{and}\; \text{cond} \;\hat=$ \enquote{there exist infinitely many}
                \item $\overset{\infty}{\forall}i \in \mathbb{N}_0: \text{cond}\;\hat=$ \enquote{for almost all, i.e., for all except for finitely many}
              \end{itemize}
            \end{minipage}
          }
        }
