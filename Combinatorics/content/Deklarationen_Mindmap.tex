...
\newcommand{\annotation}[2]{\path (#1) -- node[annotation, above, align=center, pos=0.03] {#2} (co);}

% \newenvironment{resettikz}{\pgfsetlayers{nodelayer,edgelayer}\tikzset{every node/.style={fill opacity=1.0, draw opacity=1.0}}}{}
\newenvironment{resettikz}{\tikzset{every node/.style={fill opacity=1.0, draw opacity=1.0, minimum size = 0cm}}}{}
