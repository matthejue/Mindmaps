              ...
              \resizebox{\textwidth}{!}{
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    ...
                    \item \script{693}{Example:  Beverage machines (f.)}
                    \item \script{698}{Example: Yellow and Blue}
                  \end{itemize}
                \end{minipage}
              }
            }
            ...
            child {
              node {Resolving nondeterminism (Appears naturally when)
                \resizebox{\textwidth}{!}{
                  \begin{minipage}[t]{12cm}
                    \begin{itemize}
                      \item \script{666}{Definition}
                      \item \script{660}{Example (ff.)}
                    \end{itemize}
                  \end{minipage}
                }
              }
        ...
        child {
          node {Classification of LT-properties
            \resizebox{\textwidth}{!}{
              \begin{minipage}[t]{12cm}
                \begin{itemize}
                  \item \script{703}{Overview and examples}
                \end{itemize}
              \end{minipage}
            }
          }
          child {
            node {Safety properties
              \resizebox{\textwidth}{!}{
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    \item \script{708}{Examples and classification (ff.)}
                  \end{itemize}
                \end{minipage}
              }
            }
