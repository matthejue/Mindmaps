                ...
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    ...
                    \begin{itemize}
                      ...
                      \item \href[page=212]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{Test for $2$-colorability}
                    \end{itemize}
              ...
              \begin{minipage}[t]{12cm}
                \begin{itemize}
                  ...
                  \item \alert{other terms:}
                    \begin{itemize}
                      \item \href[page=234]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{curve, polygonal curve, drawing, crossing}
                      \item \href[page=235]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{closed curve, simple curve}
                      \item \href[page=237]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{open set, region, faces}
                      \item \href[page=238]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{Jordan Curve Theorem}
                    \end{itemize}
                \end{itemize}
              \end{minipage}
            }
          ...
          child {
            node {Dual Graphs
              \resizebox{\textwidth}{!}{
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    \item \href[page=241]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{definition}
                    \item \href[page=243]{/home/areo/Documents/Studium/Summaries/Graph_Theory/Graphentheorie_english_all_in_one_with_go_back.pdf}{two embeddings of a planar graph may have non-isomorphic duals}
                  \end{itemize}
                \end{minipage}
              }
            }
