...
\begin{minipage}[t]{0.19\linewidth}
	...
	\begin{betterlist}
		...
		% \end{betterlist}
	\end{betterlist}
  \inlinebox{False positive (lock graph and lock dependency)}
  \vspace{-0.25cm}
...
%     %\end{noindent}
	...
	\inlinebox{False postive (HP and lockset)}
  \vspace{-0.25cm}
...
rel(y)                     go func() {
	...
	\inlinebox{False negative (HP, lock graph and lock dependency)}
  \vspace{-0.25cm}
