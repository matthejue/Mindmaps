								...
								node (ltl semantics applied) {LTL semantics for LT properties, Transition Systems, Paths
										\resizebox{\textwidth}{!}{
											\begin{minipage}[t]{12cm}
												\begin{itemize}
													\item \script{1358}{LT \alert{property} of formula}
													\item \script{1361}{LTL semantics over \alert{paths} of TS}
													\begin{itemize}
														\item \script{1359}{Given TS}
														\item \script{1370}{Example Trace} and \script{1395}{Example with other operators}
														\item \script{1382}{Example Trace $2$}
													\end{itemize}
													\item \script{1396}{LTL semantics over \alert{states} of a TS}
													\item \script{1401}{Interpretation of LTL formulas over TS}
													\begin{itemize}
														\item \script{1411}{Example (prr.)}
													\end{itemize}
													\item \script{1416}{Theorems}:
													\begin{itemize}
														\item For each path $\pi$ we have: $\pi \models \phi$ or $\pi \models \neg\phi$
														\item For each state $s$ we have: $s \models \phi$ or $s \models \neg\phi$
													\end{itemize}
						...
						child {
								...
								child {
										...
										child [level distance = 8cm] {
															...
															\begin{minipage}[t]{12cm}
																\begin{itemize}
																	...
																	\begin{itemize}
																		...
																		\item \script{1212}{Action-based fairness assumptions}
																	...
																	\begin{minipage}[t]{16cm}
																		\begin{itemize}
																			...
																			\begin{itemize}
																				...
																				\begin{itemize}
																					\item \script{1232}{Same example with two different mutual exclusion properties (ff.)}
												...
												child {
														node {Realizability of fairness assumptions
																\resizebox{\textwidth}{!}{
																	\begin{minipage}[t]{12cm}
																		\begin{itemize}
																			\item \script{1276}{Definition (prr.)}
																			\begin{itemize}
