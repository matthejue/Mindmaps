...
\begin{minipage}[t]{0.2\linewidth}
  ...
  \item \color{orange}Given a finite set of formulas $B$ we define the \script{452}{\alert{abstract strongest post}} operator as follows: $sp^\#_B(S, st) = \{\bigwedge \{\varphi \in B \mid sp(S, st) \subseteq \{\varphi\}\}\}$\color{black}
		\begin{betterlist}
