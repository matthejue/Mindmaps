                  ...
                  \begin{minipage}[t]{12cm}
                    \begin{itemize}
                      ...
                      \item \underline{Tasks}
                        \begin{itemize}
                          \item detecting all the implications from the assignment of a variable
                      ...
                      \begin{itemize}
                        ...
                        \item \underline{Disadvantages:}
                          \begin{itemize}
                            ...
                            \item need a list for each variable and polarity to store all the clause where the \enquote{related literal} (variable having that polarity) occurs (called \enquote{occurrences list})
                          \end{itemize}
                      \end{itemize}
                    \end{minipage}
                  }
                    ...
                    \resizebox{\textwidth}{!}{
                      \begin{minipage}[t]{12cm}
                        \begin{itemize}
                          ...
                          \item a node in the implication graph is called a \alert{Unique Implication Point} (UIP) \textit{iff} a paths from the decision variables of the current decision level to the conflict variable go through this node
                            \begin{itemize}
                        ...
                        \begin{itemize}
                          ...
                          \item Directed, acyclic graph 
                            \begin{itemize}
                              ...
                              \item Edges reflect which set of assignments have caused an implication
                            \end{itemize}
                          \item the implication graph is updated at every variable assignment and every backtrack operation of the search process
                          \item \script{304}{Example for Implication} and \script{305}{Example for Implication graph}
                        \end{itemize}
                      \end{minipage}
                    }
                  }
              ...
              \resizebox{\textwidth}{!}{
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    ...
                    \item \script{255}{Example 1 (ff.)}, \script{265}{Example 2 (ff.)}
                  \end{itemize}
                \end{minipage}
              }
            }
          ...
          child {
            node {Termination
              \resizebox{\textwidth}{!}{
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    \item Observation: Due to conflict analysis, learning, and non-chronological backtracking, it seems that modern SAT solvers roam \enquote{wildly} in the search space
