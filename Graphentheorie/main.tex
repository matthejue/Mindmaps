                ...
                \begin{minipage}[t]{8cm}
                  \begin{itemize}
                    ...
                    \begin{enumerate}
                      ...
                      \item whose \alert{vertices} can be placed around a \alert{circle} 
                      \begin{itemize}
                        \item such that two vertices are adjacent $\Rightarrow$ they are consecutive in the circle
                      \end{itemize}
                    \end{enumerate}
                  \end{itemize}
          ...
          \resizebox{\textwidth}{!}{
            \begin{minipage}[t]{8cm}
              \begin{itemize}
                ...
                \end{itemize}
                \begin{itemize}
                  \item ones says $G$ \alert{is isomorphic} $H$ if there's an \alert{isomorphism} from $G$ to $H$ ($G \cong H$)
                \end{itemize}
              \end{itemize}
            \end{minipage}
          }
