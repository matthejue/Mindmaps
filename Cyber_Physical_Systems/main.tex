													...
													\begin{minipage}[t]{20cm}
														\begin{itemize}
															...
															\begin{itemize}
																...
																\item another way to read this is \alert{if a trace violates (does not satisfy) the property e then it has a bad prefix} but what is a bad prefix well it is one that cannot be extended to trace E
