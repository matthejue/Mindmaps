...
\begin{mindmap}
  \begin{mindmapcontent}
    ...
    child {
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                  ...
                  \begin{itemize}
                    ...
                    \item \script{68}{Formal Notation}
      ...
      child {
        node {Crypto System with Keys
          \resizebox{\textwidth}{!}{
            \begin{minipage}[t]{12cm}
              \begin{itemize}
                \item \script{70}{Definition}
        ...
        child {
          node {Symmetric cryptosystems $K_E = K_D$
            \resizebox{\textwidth}{!}{
              \begin{minipage}[t]{12cm}
                \begin{itemize}
        ...
        child {
          node {Asymmetric cryptosystems $K_E \ne K_D$
            \resizebox{\textwidth}{!}{
              \begin{minipage}[t]{12cm}
                \begin{itemize}
                  ...
                  \item \underline{advantages:}
                    \begin{itemize}
                      \item allows to share public key, secure key exchange not needed
                      \item also other applications like authentication
                    \end{itemize}
                \end{itemize}
              \end{minipage}
            }
      ...
      child {
        node {Basic Types of Ciphers}
        child {
          node {Substitution ciphers
            \resizebox{\textwidth}{!}{
              \begin{minipage}[t]{12cm}
                \begin{itemize}
                  ...
                  \begin{itemize}
                    \item $C$ hides chars of $P$
                    \item if $> 1$ key alphabet, $C$ dissipates high frequency chars
                  \end{itemize}
                \end{itemize}
              \end{minipage}
            }
              ...
              \resizebox{\textwidth}{!}{
                \begin{minipage}[t]{10cm}
                  \begin{itemize}
                    ...
                    \begin{itemize}
                      \item there are $26 \times 25 \times \ldots \times 3 \times 2 \times 1 = 26! \approx 2^{88}$ substitution tables ($=$ keys)
                    \end{itemize}
                    \item \underline{Attacks:}
                    \begin{itemize}
                      \item \script{79}{Exhaustive search}, Brute-force attack is not feasible
                      \item \script{80}{Letter Frequency Analysis (ff.)}
                      \begin{itemize}
            ...
            child {
              node {Caesar Cipher
                \resizebox{\textwidth}{!}{
                  \begin{minipage}[t]{12cm}
                    \begin{itemize}
                      \item \script{74}{Defintion (f.)}
                      \item each letter in $P$ is substituted by a fixed letter. In this special case the \enquote{key} is of length $1$
                      \item \script{76}{Attack}
                    \end{itemize}
                  \end{minipage}
                }
              }
          ...
          child {
            ...
            child {
              node {Vigenère Tableaux Method
                \resizebox{\textwidth}{!}{
                  \begin{minipage}[t]{12cm}
                    \begin{itemize}
                      \item \script{86}{Definition (ff.)}
            ...
            \resizebox{\textwidth}{!}{
              \begin{minipage}[t]{12cm}
                \begin{itemize}
                  ...
                  \item \script{89}{Definition}
                  \item \underline{effects:}
                  \begin{itemize}
                    \item $C$ scrambles text, hides $n$-grams for $n > 1$
                  \end{itemize}
                \end{itemize}
              \end{minipage}
            }
