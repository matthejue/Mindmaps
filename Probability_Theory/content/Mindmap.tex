                      ...
                      % >  - und genauso $\mathbb{P}(A | B)=\mathbb{P}\left(A | B^{c}\right)\Leftrightarrow \mathbb{P}(B | A)=\mathbb{P}\left(B | A^{c}\right)$, wenn man $\mathbb{P}(A \cap B)\mathbb{P}(B)$ bzw. $\mathbb{P}(A \cap B)\mathbb{P}(A)$ auf beiden Seiten der Gleichung subtrahiert
                        ...
                        child {
                              ...
                              child {
                                node {Bernoulli-Verteilung / Null-Eins-Verteilung $B(1, p)$ or $Bernoulli(p)$
                                  \resizebox{\textwidth}{!}{
                                    \begin{minipage}[t]{12cm}
                                      \begin{itemize}
                                        \item $\displaystyle \mathbb{P}(X=1) = p, \mathbb{P}(X=0) = 1-p$
                          ...
                          child {
                            ...
                            child {
                              node {Normal- / Gaußverteilung $N(\mu, \sigma^2)$
                                \resizebox{\textwidth}{!}{
                                  \begin{minipage}[t]{12cm}
                                    \begin{itemize}
                                      \item $\displaystyle f(x) = \frac{e^{-\frac{1}{2}\left(\frac{x - \mu}{\sigma}\right)^2}}{\sqrt{2\pi}\sigma} = \frac{1}{\sqrt{2\pi \sigma^2}}e^{-\frac{(y - \mu)^2}{2\sigma^2}}$
                                      \item $F()$
                                ...
                                node {Standard-Normalverteilung $N(0, 1)$
                                  \resizebox{\textwidth}{!}{
                                    \begin{minipage}[t]{12cm}
                                      ...
                                      \item $\displaystyle \phi(z) = \int_{-\infty}^{z} \varphi(y)dy = \frac{1}{\sqrt{2\pi}} \int_{-\infty}^{z} e^{-\frac{t^2}{2}}dt$
                                      \end{itemize}
                                    \end{minipage}
                                  }
                                }
                            ...
                            child {
                              node {$\chi^2$-Verteilung $\chi^2(k)$
                                \resizebox{\textwidth}{!}{
                                  \begin{minipage}[t]{12cm}
                                    \begin{itemize}
                                      \item $\displaystyle f(x) = \frac{x^{\frac{k}{2}-1}e^{-\frac{x}{2}}}{2^{\frac{k}{2}}\Gamma(\frac{k}{2})} = \frac{1}{2^{\frac{k}{2}}\Gamma(\frac{k}{2})}\cdot x^{\frac{k}{2}-1}e^{-\frac{x}{2}}$
                                      \item $\displaystyle E(X) = k$
                                      \item $\displaystyle V(X) = 2k$
                                    \end{itemize}
                                  \end{minipage}
                                }
                              }
