										...
										\resizebox{\textwidth}{!}{
											\begin{minipage}[t]{16cm}
												\begin{itemize}
													...
													\item \script{965}{Decomposition theorem (ff.)}, \videonine{5555}{Don't write as conjunction}
													\begin{itemize}
								...
								child {
										node {Safety properties
												\resizebox{\textwidth}{!}{
													\begin{minipage}[t]{20cm}
														\begin{itemize}
															\item \enquote{\alert{nothing bad will happen}}
															...
															\begin{minipage}[t]{16cm}
																\begin{itemize}
																	...
																	\begin{itemize}
																		...
																		\begin{itemize}
																			\item \videonine{3244}{Other interesting things}, set closed means it is equal to it's closure, \alert{whenever one has a property e and one takes it's closure, then one gets a safety property}
																		\end{itemize}
								...
								child {
										node {Liveness properties
												\resizebox{\textwidth}{!}{
													\begin{minipage}[t]{16cm}
														\begin{itemize}
															\item \enquote{\alert{something good will happen}}
