...
\newcommand{\annotation}[2]{\path (#1) -- node[annotation, above, align=center, pos=0.03] {#2} (gt);}
  ...
  \begin{scope}[
    ...
    child {
      ...
      % \begin{pgfonlayer}{background}
        ...
        \edge{bipartite graphs}{independant set}
        \edge{disjointunion}{coloring}
        \edge{join}{coloring}
        \edge{cartesian}{coloring}
        \edge{vc}{isvccqcl}
        \edge{clique}{isvccqcl}
        \edge{coloring}{isvccqcl}
        \edge{vc}{apa}
        \edge{regular graphs}{degree}
        \edge{gt}{degree}
        \edge{symmetricdifferencematching}{symmetricgraphdifference}
        \edge{connectivity}{hypercube}
        \edge{edgecut}{edgeconnectivity}
        \edge{edgecut}{cut}
