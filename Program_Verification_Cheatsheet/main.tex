...
\begin{minipage}[t]{0.2\linewidth}
	\begin{betterlist}
		...
		\begin{betterlist}
			...
			\item \color{orange}\alert{Widening Operator:} A \alert{widening operator} for an abstract domain $(\mathbb{A}_S, \sqsubseteq, \alpha, \gamma)$ is a binary operator $\triangledown$ on abstract states such that\color{black}
			\begin{betterlist}
