								...
								\resizebox{\textwidth}{!}{
									\begin{minipage}[t]{12cm}
										\begin{itemize}
											...
											\end{itemize}
											\item \script{144}{Equivalence}: Two propositional logic formulas F and G are \alert{equivalent}, denoted with $F \equiv G$ , iff for every
											assignment $\mathcal{A}$ suitable for $F$ and $G$ , $\mathcal{A}(F) = \mathcal{A}(G)$ holds.
										\end{itemize}
									\end{minipage}
								}
							}
												...
												\resizebox{\textwidth}{!}{
													\begin{minipage}[t]{12cm}
														\begin{itemize}
															...
															\item \script{389}{Example 1 (ff.)}
															\item \script{402}{Analysis}
															\begin{itemize}
																\item \script{403}{Questions about Improvements}
																\begin{itemize}
																	\item \script{404}{Question 1}
																	\item \script{405}{Question 2}
																\end{itemize}
																\item \script{406}{Example 2 (ff.)}
															\end{itemize}
														\end{itemize}
													\end{minipage}
												}
