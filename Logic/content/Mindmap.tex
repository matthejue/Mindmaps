                ...
                \begin{minipage}[t]{12cm}
                  \begin{itemize}
                    ...
                    \begin{itemize}
                      ...
                      \begin{itemize}
                        \item $\hat=$ \href[page=249]{/home/areo/Documents/Studium/Summaries/Technische_Informatik/Technische_Informatik_all_in_one_with_go_back.pdf}{\alert{ON-Menge / Erfüllbarkeitsmenge}}: $ON(f) = \{\alpha\in \mathbb{B}^n \;|\; f(\alpha) = 1\}, f:\mathbb{B}^n\rightarrow \mathbb{B}$
